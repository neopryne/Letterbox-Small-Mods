...
set "ZIP_NAME=Selectively Independent Crew Control.zip"
...
set "RELATIVE_FILE=Selectively Independent Crew Control.zip"
set "ABSOLUTE_PATH=C:\Program Files (x86)\Steam\steamapps\common\FTL Faster Than Light\mods\Selectively Independent Crew Control.zip"

REM Define the path to the shortcut file
set "SHORTCUT_PATH=C:\Users\GunBuild-1\Documents\Workspace\Letterbox Small Mods\Selectively Independent Crew Control\modman_orig.exe - Shortcut.lnk"
